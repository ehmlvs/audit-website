...
with col_step1:
    ...
    try:
        with open("Microbiz_form+report.pdf", "rb") as f:
            st.download_button("📄 Example: Microbiz", data=f, file_name="Microbiz_form+report.pdf", key="ex_micro")
    except:
        pass 
    ...
    try:
        with open("Smallbiz_form+report.pdf", "rb") as f:
            st.download_button("📄 Example: Smallbiz", data=f, file_name="Smallbiz_form+report.pdf", key="ex_small")
    except:
        pass
